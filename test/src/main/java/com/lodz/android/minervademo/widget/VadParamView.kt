...
import ai.guiji.duix.test.databinding.ViewVadParamBinding
...
class VadParamView : FrameLayout {
    ...
    fun setSaveActiveVoiceText(text: String = "") {
        mBinding.saveVoiceTv.text = context.getString(R.string.vad_is_save_active_voice)
            .append(text)
    }
    ...
    fun interface OnParamChangedListener {
        fun onChanged(audioFormat: AudioFormats,
